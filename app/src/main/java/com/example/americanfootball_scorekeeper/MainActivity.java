package com.example.americanfootball_scorekeeper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void displayForTeamA(int scoreA) {
        TextView scoreView =  findViewById(R.id.teamScoreA);
        scoreView.setText(String.valueOf(scoreA));
    }

    public void displayForTeamB(int scoreB) {
        TextView scoreView = findViewById(R.id.teamScoreB);
        scoreView.setText(String.valueOf(scoreB));
    }

    public void displayResults(String message) {
        TextView messageView =  findViewById(R.id.winMessage);
